...
func TestApprovalSearchRejectsUnknownRepeatedAndInvalidParameters(t *testing.T) {
	...
	for _, path := range []string{
		...
		"/api/v1/approvals?category=firmware-flow&createdAfter=",
		"/api/v1/approvals?category=firmware-flow&createdBefore=%20",
		"/api/v1/approvals?category=firmware-flow&limit=",
