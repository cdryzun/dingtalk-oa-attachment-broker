...
| `DEVICE_CODE_TTL` | `10m` | Device and OAuth state lifetime |
| `ACCESS_TOKEN_TTL` | `8h` | Broker access token lifetime |
| `REFRESH_TOKEN_TTL` | `720h` | Broker refresh token lifetime |
| `AUTH_POLL_INTERVAL` | `5s` | Client polling interval |
